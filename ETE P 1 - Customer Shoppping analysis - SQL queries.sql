...
-- Q7. Segment customers into New, Returning, and Loyal based on their total , Using CTE
...
-- Q8. What are the top 3 most purchased products within each category? CTE and Window function
WITH item_counts AS (
    SELECT category,
           item_purchased,
...
SELECT subscription_status,
       COUNT(customer_id) AS repeat_buyers FROM customer WHERE previous_purchases > 5 GROUP BY subscription_status;
